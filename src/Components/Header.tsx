...
export default function Header() {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row md:text-sm  items-center">
    ...
    <Link href="/" className="mr-5 hover:text-gray-300 font-semibold text-cyan-50">Home</Link>
      <Link href="/about" className="mr-5 hover:text-gray-300 font-semibold text-cyan-50">About</Link>
      <Link href="/startplaning" className="mr-5 hover:text-gray-300 font-semibold text-cyan-50">Start Planing</Link>
      <Link href="/blog" className="mr-5 hover:text-gray-300 font-semibold text-cyan-50">Blog</Link>
      <Link href="/review" className="mr-5 hover:text-gray-300 font-semibold text-cyan-50">Review</Link>
      <Link href="/contact" className="mr-5 hover:text-gray-300 font-semibold text-cyan-50">Contact</Link>
